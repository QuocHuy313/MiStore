package com.MiStore.MiStore.controller.admin;


import com.MiStore.MiStore.entities.*;
import com.MiStore.MiStore.service.ChiMucGioHangService;
import com.MiStore.MiStore.service.GioHangService;
import com.MiStore.MiStore.service.NguoiDungService;
import com.MiStore.MiStore.service.SanPhamService;
        ...
        if (auth == null || auth.getPrincipal() == "anonymousUser")    //Su dung cookie de luu
        {
            ...
            for (int i = 0; i < clientCookies.length; i++) {
                if (clientCookies[i].getName().equals(id))     //Neu san pham da co trong cookie tang so luong them 1
                {
                    ...
                    clientCookies[i].setPath("/mistore");
